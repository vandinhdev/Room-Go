...
import vandinh.ictu.user_service.repositories.RoleRepository;
import vandinh.ictu.user_service.repositories.UserRepository;
import vandinh.ictu.user_service.services.AuthService;
import vandinh.ictu.user_service.services.EmailClient;
...
public class AuthServiceImpl implements AuthService {
    ...
    public void register(SignUpRequest request) {
        ...
        UserEntity user = UserEntity.builder()
                ...
                .lastName(lastName)
                .role(role)
                .status(UserStatus.PENDING) // chưa active
                .build();
